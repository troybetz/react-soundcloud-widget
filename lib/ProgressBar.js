...
var ProgressBar = React.createClass({
  ...
  /**
   * Prevent togglePlayback() being called on container
   */
  ...
  _setNewPosition: function(newPosition, containerWidth) {
    ...
    this.props.setPosition((newPosition / containerWidth) * this.props.streamInfo.duration);
  },
  ...
  _getProgressBarWidth: function() {
    return (this.props.streamInfo.position / this.props.streamInfo.duration) * 100;
  },
  ...
  render: function() {
    var containerStyles = {
      ...
      width: '100%',
      background: 'grey',
      opacity: this.props.streamInfo.isPlaying ? '1' : '0',
